...
function HTMLmostrarcarrito(id,name,price,img){
    return `<tr>
    <td>
        <div class="media">
            <div class="d-flex">
    ...
    <td>
        <div class="product_count">
            <a onclick="borrarCarrito('${id}')" class="button button-header" href="cart.html">Remover</a>
        </div>
    </td>
    <td>
        <h5>Q${price}.00</h5>
            ...
            pro1.on('value',function(snapshot){
                ...
                pro2.on('value',function(snapshot){
                    ...
                    pro3.on('value',function(snapshot){
                        var photo = snapshot.val();
                        total += price;
                        carritos.innerHTML+=`${HTMLmostrarcarrito(id,name,price,photo)}`;
                    });
                });
            });
        }
