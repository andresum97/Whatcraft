...
function HTMLmostrarcarrito(name,price,img,id){
    return `<tr>
    <td>
        <div class="media">
            <div class="d-flex">
    ...
    <td>
        <div class="checkout_btn_inner d-flex align-items-center">
        <a href="cart.html" onclick="borrarCarrito('${id}');" class="button button-header">Eliminar</a>
        </div>
    </td>
    <td>
        <h5>Q${price}.00</h5>
            ...
            pro1.on('value',function(snapshot){
                ...
                pro2.on('value',function(snapshot){
                    ...
                    pro3.on('value',function(snapshot){
                        var photo = snapshot.val();
                        total += price;
                        carritos.innerHTML+=`${HTMLmostrarcarrito(name,price,photo,id)}`;
                    });
                });
            });
        }
